...
void GameCanvas::drawCharacter() {
	character[characterframeno].draw(cx, cy, c0gw, c0gh, crot);
}
...
void GameCanvas::loadAsset(int assetNo) {
	...
	case 1:
		...
		for(int i = 0; i < characterframenum; i++) character[i].loadImage("oyun/karakterler/" + characterpath + "_tufek_0" + gToStr(i) + ".png");
		break;
	case 2:
